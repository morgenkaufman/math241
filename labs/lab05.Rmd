...
test <- ymd_hms(precip_se_pdx_data$date)
```
...
Not sure if I am supposed to answer this question or not but the reason its format isnt tidy is because 
...
```{r}
grad_long %>%
ggplot(aes(x= first_year_fall, y= graduation_rate, color=years_to_graduation))+
  geom_point()
```
