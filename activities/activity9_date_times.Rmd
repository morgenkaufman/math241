...
```{r, eval = F}
bk_jan <- readr::read_csv("https://s3.amazonaws.com/biketown-tripdata-public/2017_01.csv")
bk_jul <- readr::read_csv("https://s3.amazonaws.com/biketown-tripdata-public/2017_07.csv")
bk_nov <- readr::read_csv("https://s3.amazonaws.com/biketown-tripdata-public/2017_11.csv")
...
biketown_dt %>%
  ggplot(aes(y = wday(StartDate, label = T), x = Distance_Miles, fill = wday(StartDate, label=T))) +
  geom_density_ridges(scale = 4) +
  facet_wrap(~ (month(StartDate)), nrow = 3) +
